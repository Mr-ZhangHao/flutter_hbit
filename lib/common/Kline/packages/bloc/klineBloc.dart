...
* @LastEditTime: 2020-08-11 17:15:46
 */
import 'dart:math';

import 'package:flutter/material.dart';
import 'package:HBit/common/Kline/packages/bloc/klineBlocProvider.dart';
import 'package:HBit/common/Kline/packages/manager/klineDataManager.dart';
...
class KlineBloc extends KlineBlocBase {
  ...
  void updateLast(Market market) {
    if (klineTotalList[0].id == market.id) {
      klineTotalList.removeAt(0);
    }
    klineTotalList.insert(0, market);
    _klineListSink.add(klineTotalList);
  }
