...
* @Date: 2020-05-17 22:19:46
* @LastEditors: Mike
* @LastEditTime: 2020-05-17 22:38:01
* @Deprecated: 否
* @FilePath: /retailer_flutter/lib/common/toast/custom_loading.dart
*/
...
class CustomLoadWidget extends StatefulWidget {
  ...
  @override
  CustomLoadWidgetState createState() => CustomLoadWidgetState();
}

class CustomLoadWidgetState extends State<CustomLoadWidget>
                ...
                onPressed: () {
                  BotToast.showCustomLoading(
                      ...
                      toastBuilder: (cancelFunc) {
                        return CustomLoadWidget(cancelFunc: cancelFunc);
                      });
                },
