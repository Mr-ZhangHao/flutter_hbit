...
class ContractCoinItem extends StatelessWidget {
  final ContractAssets model;
  const ContractCoinItem({
    Key key,
    this.model,
  }) : super(key: key);
                ...
                children: <Widget>[
                  Column(
                    ...
                    children: <Widget>[
                      Container(
                        alignment: Alignment.centerLeft,
                        child: Text('${Tr.of(context).assetAccountEquity}（${model.coinName}）',
                            textAlign: TextAlign.left,
                      ...
                      Container(
                        ...
                        child: Consumer<ContractAssetProvider>(
                          builder: (BuildContext context, ContractAssetProvider value, Widget child) {
                            return Text(value.isOpen ? Utils.cutZero(model.equities) : "****",
                                textAlign: TextAlign.left,
                                style: TextStyle(
                                    color: kTextColor5,
                                    fontSize: sp(32),
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      Container(
                        alignment: Alignment.centerLeft,
                        child: Text('${Tr.of(context).tradrAvailable}（${model.coinName}）',
                            textAlign: TextAlign.left,
                            style: TextStyle(color: kTextColor7, fontSize: sp(24), height: 1.1)),
                      ),
                      Container(
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      Container(
                        alignment: Alignment.centerLeft,
                        child: Text('${Tr.of(context).assetFreeze}（${model.coinName}）',
                            textAlign: TextAlign.left,
                            style: TextStyle(color: kTextColor7, fontSize: sp(24), height: 1.1)),
                      ),
                      Container(
