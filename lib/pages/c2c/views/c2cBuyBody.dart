...
class c2cBuyBody extends StatefulWidget {
  const c2cBuyBody({
    Key key,
  }) : super(key: key);

  @override
  _c2cBuyBodyState createState() => _c2cBuyBodyState();
}

class _c2cBuyBodyState extends State<c2cBuyBody>
  ...
  void initState() {
    ...
    C2cList = Provider.of<C2cProvider>(context, listen: false).paymentInfo;
        ...
        onCurrencyTab: (e) async {
          setState(() {
            ...
            Application.eventBus
                .fire(c2cListEvent(PaymentID, currencyID, currencyModel));
          });
        },
      ),
    );
          ...
          Builder(builder: (context) {
            return GestureDetector(
              ...
              child: Container(
                  ...
                  child: Image.asset('images/c2c/c2c_screen.png',
