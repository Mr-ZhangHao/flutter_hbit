...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_seekbar/flutter_seekbar.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/fluttertoast/fluttertoast.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/fsuper/fsuper.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/loading_indicator_view/loading_indicator_view.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/unique_id/unique_id.framework"
